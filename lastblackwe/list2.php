...
<table border=3 width=800 bordercolor=black>
	<caption align=top><h1 style= font-size:20>아야 자유 게시판<h1> </caption>
...
foreach($arr as $k=>$str){
	...
	echo "<tr style=background-color:white;bordercolor=black><th>{$i}</th>
		<th>{$arr1[0]}</th>
		<th><a href=show2.php?id={$k}>{$arr1[1]}</a></th><th>{$arr1[3]}</th></tr>";
}
}
echo "</table>";
?>
...
<a href =form2.html target =if><img src="글.png" width= 120 height =30></a>
</html>
